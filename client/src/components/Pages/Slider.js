    ...
    <Carousel>
        ...
        <Carousel.Caption>
          <h3>
            <strong style={{ fontSize: "40px" }}>
              Fly to Qatar with FAST Airways
            </strong>
          </h3>
          <p>
            Be there at the Wordlcup 2022 with FAST Airways and cheer your team
            to victory.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item interval={500} className={classes.item}>
        ...
        <Carousel.Caption>
          <h3>
            <strong style={{ fontSize: "40px" }}>
              Extra legroom, extra space, extra easy
            </strong>
          </h3>
          <p>
            Pick from a choice of extras to make flying with us even more
